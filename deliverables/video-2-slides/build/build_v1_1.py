...
DECK = "Video-2-Is-Your-Job-Making-You-Less-Marketable_v1.1"
RECDECK = "Video-2-Reveal-Builds_v1.1"
N = 13
...
def main():
    ...
    sheet(pngs, os.path.join(V11, "contact-sheet-v1.1.png"), 560,
          "IS YOUR JOB MAKING YOU LESS MARKETABLE?",
          "Video 2, version 1.1   ·   13 slides   ·   1920 x 1080   ·   16:9",
    ...
    sheet(rpngs, os.path.join(V11, "recording-deck-order-v1.1.png"), 420,
          ...
          "Video-2-Reveal-Builds_v1.1   ·   %d frames   ·   sequential duplicate "
    ...
    rep["evidence_kept_generic"] = ("I own the QBR process for this business unit."
                                    in vis[3])
    rep["slide2_new_headline"] = "Being valuable here answers only one question." in vis[1]
    rep["slide2_new_support"] = ("The second question is whether another context can "
                                 "recognize and use what you have built." in vis[1])
    rep["slide2_old_copy_gone"] = ("Success answers one of them at a time." not in vis[1]
                                   and "leaving the other unresolved" not in vis[1])
    rep["slide2_frame_kept"] = all(x in vis[1] for x in
                                   ("TWO DIFFERENT QUESTIONS", "Valuable here",
                                    "Legible elsewhere"))
    ...
    print("slide 2 new copy:", rep["slide2_new_headline"], rep["slide2_new_support"],
          "| old gone:", rep["slide2_old_copy_gone"],
          "| frame kept:", rep["slide2_frame_kept"])
