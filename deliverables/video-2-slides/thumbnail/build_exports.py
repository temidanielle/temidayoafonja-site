"""Derivatives and placement simulations. Video 2.
...
ITEMS = [("final","VIDEO_2_THUMBNAIL_FINAL_3840x2160.png","Video 2 Final")]
...
def search_row(im,dark):
    ...
    d.text((80,62),"am i still marketable",font=f(32),fill=T["mut"])
