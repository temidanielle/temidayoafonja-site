# -*- coding: utf-8 -*-
"""Canonical source verification for Video 8, run in the same build pass.

Compares the approved script extracted from Video_8_Code_Prompt_HIT_Final.txt
...
b = txt.index("BEGIN APPROVED VIDEO 8 SCRIPT") + len("BEGIN APPROVED VIDEO 8 SCRIPT")
e = txt.index("END APPROVED VIDEO 8 SCRIPT")
...
tel = open(LF + "Video8TeleprompterScriptwithslidemarkers_HIT_v2.0.txt",
           encoding="utf-8").read()
rd = open(LF + "Video8ReadingScriptnomarkers_HIT_v2.0.txt", encoding="utf-8").read()
...
tel_docx = docx_paras(LF + "Video8TeleprompterScriptwithslidemarkers_HIT_v2.0.docx", 4)
rd_docx = docx_paras(LF + "Video8ReadingScriptnomarkers_HIT_v2.0.docx", 4)
