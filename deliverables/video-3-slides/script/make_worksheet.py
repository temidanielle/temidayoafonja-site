...
# ---------------------------------------------------------------- title page
h1("VIDEO 3 - FILMING WORKING SHEET")
...
para("Revision: Wednesday, August 19, 2026, America/Chicago", color=DIM)
...
table([
    ...
    ["0:00-0:50", "Opening recognition and promise", "Memorize exactly"],
...
para('Anchor line: "Preserving your record does not mean taking their material. If you '
     "would not be comfortable explaining it to your next employer's legal team, leave it.\"")
...
doc.save(os.path.join(HERE, "Video-3-Unscript-Working-Sheet_v1.0_Temidayo_Afonja.docx"))
