...
DECK = "Video-3-Before-You-Quit-Your-Job-Check-These-3-Things_v1.0"
RECDECK = "Video-3-Reveal-Builds_v1.0"
N = 13
...
def main():
    ...
    sheet(pngs, os.path.join(V11, "contact-sheet-v1.0.png"), 560,
          "BEFORE YOU QUIT YOUR JOB, CHECK THESE 3 THINGS",
          "Video 3, version 1.0   ·   13 slides   ·   1920 x 1080   ·   16:9",
    ...
    for i, (n, s) in enumerate(RECORDING_PLAN):
        ...
        rlabels.append(t)
    sheet(rpngs, os.path.join(V11, "recording-deck-order-v1.0.png"), 420,
          "RECORDING DECK, ADVANCE ORDER",
          "Video-3-Reveal-Builds_v1.0   ·   %d frames   ·   sequential duplicate "
          "slides, no animations" % len(rpngs), labels=rlabels)
    sheet(pngs, os.path.join(V11, "phone-thumbnail-check-v1.0.png"), 320,
    ...
    with open(os.path.join(V11, "qa-raw-v1.0.json"), "w") as f:
