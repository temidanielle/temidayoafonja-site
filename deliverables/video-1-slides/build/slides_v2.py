"""
Video 1 deck, version 2. Ten slides.
...
def slide_02(sl, step=1):
    ...
    block(sl, 120, 632, 1240, [
        ("Accounting and audit trained me to look for evidence, controls, risk and\n"
         ...
         "cybersecurity workforce strategy and later into people strategy.",
...
after the redesign my team and I led. The number becomes useful because I
can explain what it measured, what changed and what I was responsible for."
