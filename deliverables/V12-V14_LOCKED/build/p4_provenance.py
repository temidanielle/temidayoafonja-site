...
SOURCES = {
12: [
 dict(role="RECONCILIATION INPUT \u2014 REVISED MASTER",
      name="V12_FINAL_Revised_Recording_Master.docx",
      where="Uploaded to this session, September 22, 2026. Read in full; FINAL in a filename was not treated as authority.",
      sha="8d75df4605e34c5e6eaed6861972283cde58f51dc202982914341658bffc7ae2",
      size="42,320 bytes",
      note="Uploaded September 22, 2026 with the in-depth editorial review. Read in full, not accepted on the strength of FINAL in its filename. Five of its edits were adopted word for word: the introduction, the twelve-words paragraph, the softened inspectable-evidence line, the takeaway, and the CTA. Its remaining first, second, third and fourth question labels were NOT adopted, because the reconciliation brief requires the prompts to stop being counted as a set."),
 dict(role="RECONCILIATION INPUT \u2014 EDITORIAL REVIEW",
      name="V12-V14_IN_DEPTH_Editorial_Review_and_Packaging_Recommendations.docx",
      where="Uploaded to this session, September 22, 2026.",
      sha="75de7eb5ea1371862948a9fe64559600c41ad2576f1330d73dcd3b396db2daea",
      size="41,286 bytes",
      note="Uploaded September 22, 2026. Supplied the diagnosis, the do-not-rewrite lists for all three videos, and the V14 title and thumbnail now recommended as Option A."),
...
13: [
 dict(role="RECONCILIATION INPUT \u2014 REVISED MASTER",
      name="V13_FINAL_Revised_Recording_Master.docx",
      where="Uploaded to this session, September 22, 2026. Read in full; FINAL in a filename was not treated as authority.",
      sha="118793d77c79b3e68f00a0f2930e7b4d7e7f77a2acb2d17a1db256d8f6f9fdff",
      size="42,743 bytes",
      note="Uploaded September 22, 2026. All four of its edits were adopted word for word: the removal of shared spine, and the replacement of gate language with hard requirement in three places. Two further phrases the brief asked me to look at, control artifact and coordination rhythm, and the sentence about learning a trading desk's rhythm, were simplified here."),
 dict(role="RECONCILIATION INPUT \u2014 EDITORIAL REVIEW",
      name="V12-V14_IN_DEPTH_Editorial_Review_and_Packaging_Recommendations.docx",
      where="Uploaded to this session, September 22, 2026.",
      sha="75de7eb5ea1371862948a9fe64559600c41ad2576f1330d73dcd3b396db2daea",
...
14: [
 dict(role="RECONCILIATION INPUT \u2014 REVISED MASTER",
      name="V14_FINAL_Revised_Recording_Master.docx",
      where="Uploaded to this session, September 22, 2026. Read in full; FINAL in a filename was not treated as authority.",
      sha="02e5bee7a73c4002c38913726cc826f8b850e21abb7b22e480b66f6747bed7b4",
      size="42,699 bytes",
      note="Uploaded September 22, 2026. Most of its heavier voice pass was adopted, including the human bridge, the two-question shape, and the retirement of opposite locks. Five residues were still corrected here: the gate in the hook, gating on in the first verdict, hard gate in the writing section, the unsupported most resumes claim, and the retired packaging language still sitting in its metadata. What that language was, and why it was retired, is recorded in the locked packaging document."),
 dict(role="RECONCILIATION INPUT \u2014 EDITORIAL REVIEW",
      name="V12-V14_IN_DEPTH_Editorial_Review_and_Packaging_Recommendations.docx",
      where="Uploaded to this session, September 22, 2026.",
      sha="75de7eb5ea1371862948a9fe64559600c41ad2576f1330d73dcd3b396db2daea",
...
PACKAGING_DOC = dict(
  name="YouTube_V4-V14_Title_Thumbnail_Construction_Recommendations.docx",
  sha="eb35fe2784fcb0892d10b332a4b4608101df72278d9d551205b3fcff46774964",
  size="39,187 bytes",
  where="Uploaded to this session, September 22, 2026. The only genuinely new document in the "
        "lock pass.",
  note="Confirms V12, V13 and V14 packaging and supplies the construction rule. Its alternative "
       "titles and thumbnails for V4 through V11 were read and deliberately not acted on.")

REUPLOADS = ("Four of the five documents supplied with the lock instruction are byte-identical to "
             "the four supplied the previous day and already consumed by the reconciliation: the "
             "V12, V13 and V14 revised masters and the in-depth editorial review. Their SHA-256 "
             "values match the ones recorded in the source hierarchy above, so they were verified "
             "by checksum rather than re-reconciled. The fifth, the V4 to V14 title and thumbnail "
             "construction document, is new and is recorded separately.")

SCRIPTURE = ("NLT WORDING REQUIRES VERIFICATION. No authorized New Living Translation text "
             "exists in this workspace. A search of every .txt, .md and .json file for the "
             "phrase New Living Translation returned nothing outside previously shipped "
             "descriptions, which are deliverables rather than a source. The three verses in "
             "these descriptions are therefore recorded as intended references and are marked "
             "unverified on the page itself. Confirm each against an NLT edition before "
             "publishing. The Tyndale permission line is carried in full.")
