# -*- coding: utf-8 -*-
"""Every piece of content for the 2027 playlist kit.
...
PLAYLIST_TITLE = "How to Get a New Job in 2027 Without Starting Over"
PLAYLIST_DESC = ("A three-part series for experienced professionals: the five "
                 "steps before your résumé, how to answer “you "
...
V1 = dict(
    n=1,
    slug="VIDEO_1_NEW_JOB_2027",
    publish="Monday, January 4, 2027",
    publish_time="7:00 a.m. Central",
    title="How to Get a New Job in 2027 When You Have 10+ Years of Experience",
    alt_title="How to Change Jobs in 2027 Without Starting Over",
    ...
    tags=["new job 2027", "job search 2027", "career change",
    ...
    chapters=[
        ...
        ("3:30", "Step 2: Build your evidence before your résumé"),
    ...
    hook=[
        ...
        "job in 2027 if I were you.",
    ],
    roadmap=[
        "In this video, I will walk you through five steps. First, deciding "
        "what kind of move you are making. Second, building your evidence "
        "before your résumé. Third, translating what travels. "
        "Fourth, becoming referable, even if your network is thin. And fifth, "
        "naming the gap before they do.",
    ...
    middle=[
        ("0:45", "WHY THE USUAL ADVICE FAILS YOU", [
            ...
            ("say", "Before the résumé, there is work to do. Five "
                    "steps."),
        ]),
        ("2:00", "STEP 1: DECIDE WHAT KIND OF MOVE YOU ARE MAKING", [
    ...
    description=[
        "Looking for a new job in 2027 with ten or more years of experience? "
        ...
        "résumé, and a rapid-fire round of real questions people "
        "have asked me.",
...
V2 = dict(
    ...
    publish="Wednesday, January 6, 2027",
    publish_time="7:00 a.m. Central",
    ...
    hook=[
        "You have ten, fifteen, maybe twenty years of experience. The posting "
...
V3 = dict(
    ...
    publish="Friday, January 8, 2027",
    publish_time="7:00 a.m. Central",
    title="How to Get Referred When Your Network Is Thin",
    alt_title="No Network? How Experienced Professionals Get Referred in 2027",
    ...
    description=[
        ...
        "Free Career Evidence Starter: "
        "https://temidayoafonja.com/career-evidence-starter",
        "Watch the full playlist: How to Get a New Job in 2027 Without "
        "Starting Over",
    ],
