...
12: [
 ...
 ("V12_FS_06_THE_REWRITE", "THE SAME ACCOMPLISHMENT, REBUILT",
 ...
 ("V12_FS_08_TEN_MINUTES", "TEN MINUTES",
  ["2    what was true before", "3    what was mine to decide",
   "2    what was not obvious", "3    what changed, and how I know"], None),
...
14: [
 ...
 ("V14_FS_03_OPPOSITE_LOCKS", "SIDE BY SIDE",
  ["HUMANA    method hard, domain preferred",
   "J.P. MORGAN WEALTH MANAGEMENT    industry hard, method preferred"],
  "POSTING LANGUAGE ONLY. NEITHER POSTING WAS OPEN ON THE COLLECTION DATE."),
 ("V14_FS_04_PROVES_OR_SUGGESTS", "PROVES / SUGGESTS",
  ["PROVES    a date, a scope, a number with a method under it, a decision that could have gone the other way",
   "SUGGESTS    strategic, transformational, extensive experience, proven track record"], None),
 ("V14_FS_05_EVIDENCE_OF", "AFTER EACH POSTING",
  ["This gives me evidence of …", "It does not yet prove …", "What I still cannot tell is …"], None),
 ...
 ("V14_FS_07_TWO_PASSES", "READ IT TWICE",
  ["FIRST PASS    required or preferred, in the posting's own words",
   "SECOND PASS    what it gives me evidence of, what I still cannot tell"], None),
...
14: [
 ...
 ("This gives me evidence that method is the gate here. It does not prove that the domain does not matter at all.",
  "Camera. The two-part verdict sentence is the format of the video and should be delivered the same way both times."),
 ("Two employers. Work that reads nearly the same. Opposite halves locked.",
  "Camera, with the two-column card still on screen behind or beside if a split is available."),
 ("Most resumes are mostly suggestion. That is normal. The fix is not to delete the suggestions.",
  "Camera, gentle. This is the sentence that keeps the episode from feeling like an accusation."),
 ("You do not have to guess what the reader wants. On a good day, they wrote it down. Read it.",
...
14: [
 ...
 ("A line suggests something when the reader has to supply the belief. Strategic. Transformational. Extensive experience. Proven track record. None of those can be checked, and a careful reader treats them as decoration.",
  "Fill the SUGGESTS column of the proves/suggests card word by word as each one is spoken."),
]
}
...
14: [
 ("Same family of work. Opposite locks.", "Cold open accent as the second column lands."),
 ("I do not know.", "Silence. Nothing under the rule."),
 ("This gives me evidence that method is the gate here. It does not prove that the domain does not matter at all.", "One low accent, used identically after both postings so the pattern is audible."),
 ("This gives me evidence that the industry clock is the gate. It does not prove that a strong outside candidate would never be considered.", "The same accent, same placement. The repetition is the point."),
 ("Two employers. Work that reads nearly the same. Opposite halves locked.", "Accent on the swap animation."),
 ("On a good day, they wrote it down. Read it.", "Final accent on “Read it,” then out."),
],
}
