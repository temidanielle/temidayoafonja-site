"""Build the two Video 4 script files from the production package.

Every spoken word is copied out of the package. Nothing is rewritten, expanded,
summarised or reordered.

  Video_4_Teleprompter_Script_with_Slide_Markers.docx
  ...
  Video_4_Recording_Script_Clean.txt
...
SRC = ("/root/.claude/uploads/f121668d-e262-5eb8-9b22-0eaa1006a361/"
       "db46bc1b-YouTube_Video_4_Production_Package_Career_Change_1.docx")
...
CUES = [
    (1,  "Career path",
     "I know this problem because I had to learn how to explain my own path", "after"),
    (2,  "Chronology and portability",
     "Then someone asks, “Walk me through your background,”", "before"),
    (3,  "Part 1, name the chapters briefly",
     "The first part is to name the chapters briefly.", "before"),
    (4,  "Part 2, find the repeated work",
     "The second part is to find the repeated work beneath the titles.", "before"),
    (5,  "Look beneath the nouns",
     "Look for verbs rather than nouns.", "before"),
    (6,  "Part 3, explain the direction",
     "The third part is to explain why the work you want next follows", "before"),
    (7,  "Three-sentence structure",
     "A simple three-sentence structure can help:", "before"),
    (8,  "Honesty boundary",
     "There is one important boundary here:", "before"),
    (9,  "Explanation test",
     "Finally, test the explanation with three questions.", "before"),
    (10, "Keep the Proof",
     "If your career makes sense but the examples are hard to retrieve", "before"),
    (11, "Watch next",
     "The next question is whether you need a different employer at all.", "before"),
]

STATES = {1: 4, 2: 2, 4: 5, 5: 2, 6: 3, 7: 3, 9: 3}
...
def build():
    ...
    h = para("How to Explain Your Career Change", size=26, bold=True, color=NAVY,
             after=2, spacing=1.1)
    para("Video 4  ·  Teleprompter script with slide markers", size=12,
    ...
    out_txt = os.path.join(HERE, "Video_4_Recording_Script_Clean.txt")
