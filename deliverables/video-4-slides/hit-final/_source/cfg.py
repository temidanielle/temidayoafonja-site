...
SUPPORTING=("how to explain your career change · how to explain a nonlinear "
 "career · nonlinear career path · career pivot · career story · transferable "
 "skills · career transition · career portability")
CTA="Free Career Evidence Starter"
CTA_URL="https://temidayoafonja.com/career-evidence-starter"
NEXT_FULL="Video 5 — Should I Make an Internal Move? 3 Questions to Decide"
SLIDES=11; FRAMES_TOTAL=26
...
METADATA=[("Title",TITLE),("Thumbnail",THUMB),("Primary search phrase",PRIMARY),
 ...
 ("Memory device","The three-sentence career explanation. No acronym, no "
  "second framework.")]
METADATA_NOTES=[
 "Do not restore Keep the Proof as the CTA. Do not add the Capability "
 "Formation Field Kit, CAR or the Career Evidence 3 Cs to this video.",
...
RECOGNITION=[
 "Someone looking at their own CV thinking: this makes sense to me because I "
 "lived it, and I am not sure it makes sense to anyone else.",
 "They have probably had the experience of watching someone's attention go "
...
ASSETS=["slide 1, the four chapters as chronology;",
 "slide 2, chronology beside portability;",
 "slide 5, the nouns that hide the work;",
 "slide 7, the three sentence stems;",
 "slide 10, the real Career Evidence Starter artifact."]
FACT_BLOCKS=[
 "THE CAT-WITH-NINE-LIVES FACT IS BOUNDED. A senior-manager friend at EY used "
 "to joke that Temidayo was a cat with nine lives, because her career kept "
 "turning up somewhere unrelated. That is the entire approved fact. Do not "
 "invent the original conversation, do not add dialogue for the friend, and "
 "use NO cat imagery anywhere — edit, graphics or thumbnail.",
 "THE HONESTY BOUNDARY IS THE POINT OF THE VIDEO. Never imply every move was "
 "planned, and never imply everything transfers. The script says both out "
 "loud, more than once. Do not trim either."]
FACT_LIST=["2008 financial-crisis context stays exactly as spoken;",
 "no invented employer, client, metric or result;",
 "no claim that the chapters are one profession;",
 "no forced connection the evidence does not support;",
 "permitted evidence only in the written exercise."]
DONOTUSE=["cat imagery of any kind;","stock office B-roll;",
 "résumé-scroll animations;","employer logos;","timeline graphic gags;",
 "fake shock expressions;","constant zooms;","AI-generated scenery;",
 "social-media template effects;","anything that makes a nonlinear career "
 "look like a failure."]
...
SHORT_BLOCKS=[
 ("SHORT 1","Recognition / story","A CAREER THAT NEEDS EXPLAINING",
  ["FACTUAL BOUNDARY: the joke is the whole fact. No invented conversation, no "
   ...
   "End on:  THE EXPLANATION WAS."]),
 ("SHORT 2","Distinction / myth","CHRONOLOGY ≠ EXPLANATION",
...
TAGS=("how to explain your career change, nonlinear career, career pivot, "
 ...
 "professionals, Temidayo Afonja, Capability Formation")
PINNED=["Which part of this is happening in your situation right now?",
 "1. Your chapters look unrelated on paper",
 "2. You can name what you did but not what it built",
 "3. You have a direction in mind and cannot explain why it follows",
 "Try the three sentences out loud on your own career and tell me which one "
...
def desc(CH):
 ...
 CTA_URL,"",
 "⏱️ CHAPTERS"]+CH+["",
 "▶️ WATCH NEXT","Should I Make an Internal Move? 3 Questions to Decide",
 "[ADD VIDEO 5 LINK WHEN LIVE]","",
 ...
 "#CareerChange #NonlinearCareer #CareerPivot"]
