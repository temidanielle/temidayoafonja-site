...
A card is placed at the FIRST spoken paragraph that matches its trigger and
nowhere else, so one card can never be cued twice."""
import v1011 as S
...
if __name__ == "__main__":
    for n in S.VIDEOS:
        ...
        print("NEW V%d  %2d camera stretches  %2d full-screen cues  "
              "%4d of %4d words on camera"
              % (n, cam, full, on_camera_words(n), S.word_count(n)))
