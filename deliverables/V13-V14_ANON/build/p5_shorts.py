...
(12, 2): dict(
 ...
 ask=["Write down what was true before, what was mine to decide, what was not obvious, and what changed and how I know."],
...
(13, 3): dict(
 ...
 hold=["Some of it you only pick up by being near it. You can read about how a trading desk works. You learn how one actually runs by sitting near it.",
...
(14, 1): dict(
 label="TWO JOBS, DIFFERENT REQUIREMENTS",
 card="V14_FS_03_SIDE_BY_SIDE",
 ...
 hold=["The first, from a health insurer, says in writing that the person should be comfortable working on new projects with limited knowledge of the content and be able to learn quickly. The hard requirements are five years of project management and a degree. Everything about the subject matter is listed as preferred.",
       "The second, from a wealth management business at a large bank, wants seven or more years of experience in the financial services industry. That one is hard. A project management background is listed as preferred.",
 ...
 cut="Cut to camera on “Same family of work. Very different requirements.”",
),
(14, 2): dict(
 label="WHAT A READER CAN CHECK",
 card="V14_FS_04_WHAT_A_READER_CAN_CHECK",
 stop=["A line gives stronger evidence when a reader has something they can check. A date. A scope. A number with a method under it. A decision you made that somebody else could have made differently."],
 hold=["A line only hints at something when the reader has to supply most of the belief. Strategic. Transformational. Extensive experience. Proven track record. Those words may be true, but by themselves they do not give the reader much to check.",
 ...
 cut="Cut to camera on “Both kinds of lines are normal.”",
),
(14, 3): dict(
 ...
 hold=["What I can do is read what is written and separate what the words support from what they only hint at. That may sound like a smaller claim, but it is a much more honest one.",
