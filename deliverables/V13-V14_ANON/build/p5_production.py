...
13: [
 ...
 ("V13_FS_02_THREE_RISKS", "MANAGE RISK",
  ["HEALTH INSURER    project risk register    a project slips",
   "BANK    all applicable risk programs    regulatory and financial exposure",
   "HOSPITAL SYSTEM    duty officer, surge events    patient care"],
 ...
 ("V13_WATCH_NEXT", "WATCH NEXT",
  ["I Read Two Similar Jobs. They Wanted Different Proof"], None),
],
14: [
 ...
 ("V14_FS_02_POSTING_ONE", "POSTING ONE",
  ["HEALTH INSURER    Senior Project Manager", "HARD    5 years of project management, a degree",
 ...
 ("V14_FS_03_SIDE_BY_SIDE", "SIDE BY SIDE",
  ["HEALTH INSURER    project management required, subject matter preferred",
   "WEALTH MANAGEMENT AT A LARGE BANK    industry years required, project management preferred"],
...
14: [
 ...
 ("Then look at the requirements. Seven or more years of experience in the financial services industry. Hard. PowerPoint and Excel, hard. Wealth management and knowledge of that bank's own business model, preferred. A project management background, preferred.",
