...
SUPPORTING=("should I make an internal move · internal move · internal "
 "mobility · internal job transfer · career growth · career decision · should "
 "I leave my company · career portability · internal career move")
CTA="Career Decision Evidence Check"
CTA_URL="https://temidayoafonja.com/career-decisions"
NEXT_FULL="Video 6 — Are You Growing—or Just Being Given More Work?"
SLIDES=12; FRAMES_TOTAL=25
TITLE_EXTRA=[]; THUMB_EXTRA=[]; PUB_EXTRA=[]
EDB_COMPRESS=(1.02,0.26); PUB_COMPRESS=(1.04,0.34); SEB_COMPRESS=(1.06,0.34)
...
METADATA=[("Title",TITLE),("Thumbnail",THUMB),("Primary search phrase",PRIMARY),
 ...
 ("Memory device","The three questions. No acronym, no second framework.")]
METADATA_NOTES=[
 "Do not add CAR — it belongs to Video 6. Do not add the Career Evidence 3 Cs, "
 "the Field Kit, Keep the Proof or the Career Evidence Starter to this video.",
 "Do not name the employer in the maternity-return proof, anywhere, ever."]

IDENTITY=("Become the professional who can read any opportunity — inside or "
 "outside — for what it will actually build in them, instead of chasing the "
 "title and finding out afterwards.")
IDENTITY_NOTE=("The last line of that section is the point: once the viewer can "
 "do this, they stop needing anyone to tell them whether an opportunity is "
...
BELONGING=["About six months after Temidayo came back from maternity leave in "
 ...
 "The meaningful part was being trusted with DIFFERENT work. Not more of the "
 "same work. That distinction is the whole video.",
...
REVEAL_MAP=[(1,"1–2",2),(2,"3–5",3),(3,"6",1),(4,"7–10",4),(5,"11",1),
 ...
 (11,"24",1),(12,"25",1)]
ASSETS=["slide 1, INTERNAL MOVE ≠ AUTOMATIC GROWTH, drawn not typeset;",
 "slide 4, the four access variables;",
 "slide 6, MORE TASKS beside MORE JUDGMENT;",
 "slide 8, RESULT / JUDGMENT / RANGE;",
 "slide 9, the 3 / 2 / 0–1 read, never gamified."]
FACT_BLOCKS=[
 "THE MATERNITY-RETURN PROOF IS BOUNDED. About six months after Temidayo came "
 "back from maternity leave in one chapter of her career, her scope expanded "
 "beyond the original box of the role, and the meaningful part was being "
 "trusted with different work. That is the entire approved fact. No employer, "
 "no assignment, no result, no promotion, no metric, no conversation.",
 "NO MATERNITY OR BABY IMAGERY. The proof is Temidayo saying what happened. Do "
 "not dramatise it and do not illustrate it."]
FACT_LIST=["no employer named anywhere;","no invented assignment or result;",
 "no claim that every internal move is growth;",
 "no claim that an external move is automatically better;",
 "pay, caregiving, location, immigration status, energy and timing remain "
 "legitimate;","the health, safety, harassment and discrimination boundary "
 "stays exactly as spoken."]
DONOTUSE=["maternity or baby imagery;","stock office B-roll;",
 "transfer arrows;","doors or ladders;","org-chart animations;",
 "employer logos;","fake promotion graphics;","constant zooms;",
 "AI-generated scenery;","social-media template effects."]
...
SHORT_BLOCKS=[
 ...
 ("SHORT 3","Proof / personal evidence","MORE WORK WASN’T THE POINT",
  ["FACTUAL BOUNDARY: about six months after returning from maternity leave, "
   ...
   "promotion or metric. NO maternity or baby imagery.",
   "Then:  TRUSTED WITH DIFFERENT WORK",
   "End on:  WHAT ARE YOU BECOMING TRUSTED TO DO?"]),
 ("SHORT 4","Practical test / action","3 QUESTIONS BEFORE YOU MOVE",
  ["Reveal the three questions, then the 3 / 2 / 0–1 read.",
...
PINNED=["Which part of this is happening in your situation right now?",
 "1. You want different work and assumed you had to leave to get it",
 "2. You are being offered more responsibility and cannot tell what kind",
 "3. People here value you but still see you in one shape",
 "Tell me which one. And what is the one thing you would need to be trusted to "
 "decide for this to count as growth?",
 "If you are actively weighing whether to stay, move internally or leave, the "
...
def readme_head(W,RT):
 ...
 "Title:             %s"%TITLE,
 "Thumbnail:         %s"%THUMB,"",
 "Identity promise:  Become the professional who can read any opportunity -",
 ...
 "                   trusted with DIFFERENT work, not more of the same. No",
 "                   employer is named and no assignment, result, promotion or",
 "                   metric is invented.","",
 "Memory structure:",
 "  Will the work change?",
 "  Will your judgment expand?",
...
def readme_tail():
 ...
 "The maternity-return proof is bounded to the established fact. No employer is",
 "named. No assignment, result, promotion, metric or conversation is invented.",
 "No maternity or baby imagery is used. Every internal move is not growth, and",
 "an external move is not automatically better. Pay, caregiving, location,",
 "immigration status, energy and timing remain legitimate. The health, safety,",
 "harassment and discrimination boundary stays exactly as spoken. The Career",
 "Decision Evidence Check is the only CTA.",""]
