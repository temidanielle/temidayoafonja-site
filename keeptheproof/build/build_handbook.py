...
story += [SP(6), EY("Keep the Proof"),
    ...
    SP(10), RULE(),
    Paragraph("Written and designed by Temidayo Afonja, Founder, The Density Group.  " + URL, S["note"]),
]
story += [PageBreak()]
...
story += [Bookmark("Welcome", 0), SP(6), EY("Welcome"),
    ...
    P("The work was constant. You solved the problem, absorbed the lesson, and moved to the next thing before the last one had a name. Months later a review, a promotion case, or a sudden change asks you to account for a year, and you find yourself reaching for details that have already gone soft."),
    ...
    Paragraph("Founder, The Density Group", S["note"]),
]
story += [PageBreak()]
...
story += [SP(6), EY("The category"),
    ...
    SP(6),
    P("This is disciplined recordkeeping. The aim is to make your work accurate and findable, so that when a moment arrives that depends on the details, the details are there and you can trust them. Done well, an accurate record is more persuasive than an inflated one, because it holds up when someone asks a second question."),
    SP(2),
...
story += [SP(6), EY("The filter"),
    ...
    P("You cannot record everything, and you should not try. Activity is not contribution. Answering forty emails is activity. Deciding which of the forty needed a decision, and getting that one right, is contribution. The filter below keeps the record small and worth keeping."),
...
story += [SP(4),
    CO("A simple test",
       "Before you record something, ask: if I described this to a thoughtful stranger, would they understand what I contributed and why it mattered? If the honest answer is no, either find the contribution underneath the activity, or leave it out.",
       bg="sand", bar=GOLD),
]
story += [PageBreak()]
...
story += [SP(6), EY("The boundary"),
    ...
    P("This is the distinction the whole system depends on, so it is worth stating plainly. Your career evidence is your own account of your work. An employer-owned artifact is the material itself: the deck, the model, the code, the client file, the report. You keep your own account of the work. The artifact stays with your employer."),
...
story += [SP(4),
    CO("What the record runs on",
       ...
       bg="sand", bar=GOLD),
    SP(4),
    NOTE("This guide is educational and is not legal advice. It cannot read your employment agreement or your employer&#8217;s policies. Where a question of permission matters, ask your manager, your human resources team, or an attorney before you keep anything."),
]
story += [GAP()]
...
doc = KTPDoc(OUT, footer_title="Keep the Proof", url=URL, version="v1.0.2")
...
doc.keywords = "career evidence, work accomplishments, portable language, confidentiality, Temidayo Afonja, Keep the Proof v1.0.2"
doc.build(story)
print("wrote", OUT)
