...
class StartHereDoc(BaseDocTemplate):
    def __init__(self, filename):
        super().__init__(filename, pagesize=(PAGE_W, PAGE_H), leftMargin=MARGIN,
            ...
            subject="Keep the Proof v1.0.2", keywords="Keep the Proof, v1.0.2")
    ...
    def _bg(self, canv, doc):
        ...
        canv.drawCentredString(PAGE_W/2, 40,
            "Keep the Proof v1.0.2  |  For the purchaser’s personal use")
...
story = [
    ...
    P("2.  Print the pages you need, or copy the prompts into any notebook or document you control.", olist),
    ...
    Spacer(1, 5),
    P("Already lost access to your work systems? Begin with the Starting Late module.", body),
    P("Applying for a specific role? Finish with Match Your Proof to a Role.", body),
