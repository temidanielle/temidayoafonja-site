...
def story(S, P, LEAD, H2, H3, EY, KI, NOTE, SP, bullets, CO, TBL, RULE,
    ...
    st += [Bookmark("The complete 60-minute setup", 1), IconMark(chip_mark(ic_clock60)), SP(6), EY("Start here"),
        ...
        TBL([["Time", "What you do"],
             ["0&#8211;10 min", "Read the permission rule and the three tiers again. Choose a private home you control and turn on a password and multifactor authentication. Permission comes first, then storage."],
    ...
    st += [SP(6), EY("Starting late, continued"),
        ...
        TBL([["Time", "What you do"],
             ...
             ["25&#8211;45 min", "Write at least three Quick Captures from memory, anchored to moments you recall clearly. Mark each one Sure, Approximate, or Unsure."],
             ["45&#8211;55 min", "Expand your strongest capture into a Full Entry. Keep the confidence marker on each field."],
