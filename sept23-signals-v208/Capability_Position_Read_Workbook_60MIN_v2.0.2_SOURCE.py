# -*- coding: utf-8 -*-
"""Capability Position Read — Workbook, 60-minute edition, v2.0.2 CANDIDATE.

CHANGE FROM v2.0.1, AND IT IS THE ONLY ONE: page 8, the Next-Move Note, gains
...
OUT = "v2/out/Capability_Position_Read_Workbook_60MIN_v2.0.2_CANDIDATE.pdf"
...
def attach_field_behaviour():
    ...
    SRC = "v2/out/Capability_Position_Read_Workbook_60MIN_v2.0.2_CANDIDATE.pdf"
