...
ROOT = "scratchpad/sept23/pkg/September_23_Stay_or_Leave_CANDIDATE_v3"
A = "sept23-v207-assets"
...
LAYOUT = {
 ...
 "03_QA_AND_CHANGE_CONTROL": [
   f"{A}/Free_Flagship_60MIN_v2.0.10_Change_Log_and_QA_Report.docx",
 ...
 "04_BUILD_AND_REPRODUCIBILITY": [
   ...
   f"{A}/SOURCE_build_report_v2010.py", f"{A}/SOURCE_build_checklist_v13.py",
   f"{A}/SOURCE_qa_v207.py"],
}
...
def main():
    ...
    man = open("scratchpad/sept23/manifest_head_v3.txt", encoding="utf-8").read()
    ...
    Z = "September_23_Stay_or_Leave_CANDIDATE_Asset_Package_v3.zip"
    if os.path.exists(Z):
        os.remove(Z)
