# -*- coding: utf-8 -*-
# ============================================================================
# EDITABLE SOURCE — Capability Position Read, Workbook v1.3
#
# Script-built: editing this file and re-running it regenerates the PDF whole
# — every page, field, constraint and calculation.
#
#   python3 Capability_Position_Read_Workbook_v1.3_SOURCE.py
#
# Requires reportlab, pypdf, and Cormorant Garamond / DM Sans / Montserrat as
# .ttf in work/gf/. The build refuses to emit a page whose content crosses the
# footer rule; guard() raises rather than letting an overrun ship.
#
# v1.1  bare "?" rejected on corrected-score fields; totals no longer read-only
# v1.2  renamed Worksheet -> Workbook; page-7 matrix gives the three states one
#       shared fill and sets Compounding apart in navy
# v1.3  the visible label is simply "Workbook" — "Free Flagship" removed from
#       the cover, the running header and the filename
# ============================================================================
"""Capability Position Read — Workbook v1.3 CANDIDATE.
...
OUT = "out/Capability_Position_Read_Workbook_v1.3_CANDIDATE.pdf"
...
c.setTitle("Capability Position Read — Workbook")
...
def attach_field_behaviour():
    ...
    SRC = "out/Capability_Position_Read_Workbook_v1.3_CANDIDATE.pdf"
