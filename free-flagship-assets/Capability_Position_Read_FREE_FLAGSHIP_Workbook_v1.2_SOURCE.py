# -*- coding: utf-8 -*-
# ============================================================================
# EDITABLE SOURCE — Capability Position Read, Free Flagship Workbook v1.2
#
# This document family is script-built, so this file is the source of record.
# Editing it and re-running it regenerates the PDF whole: every page, field,
# constraint and calculation.
#
#   python3 Capability_Position_Read_FREE_FLAGSHIP_Workbook_v1.2_SOURCE.py
#
# Requires: reportlab, pypdf, and the three brand typefaces as .ttf files in
# work/gf/ — Cormorant Garamond, DM Sans and Montserrat. All Open Font License
# faces, the same families the deck embeds.
#
...
#
# v1.1: a bare "?" is rejected on corrected-score fields; the four axis totals
#       are no longer read-only, so they can be typed in a reader without
#       form JavaScript.
# v1.2: renamed Worksheet -> Workbook throughout; page-7 matrix gives the three
#       states one shared fill and sets Compounding apart in navy.
# ============================================================================
"""Capability Position Read — FREE FLAGSHIP Workbook v1.2 CANDIDATE.
...
OUT = "out/Capability_Position_Read_FREE_FLAGSHIP_Workbook_v1.2_CANDIDATE.pdf"
...
c.setTitle("Capability Position Read — Free Flagship Workbook")
...
def page_frame(n, eyebrow_txt):
    ...
    c.drawRightString(PW - MR, PH - 34, "FREE FLAGSHIP WORKBOOK")
...
c.drawString(ML + 24, PH - 149, "Free Flagship Workbook")
...
y -= 4 * 15 + 6
y = para("Everything in this workbook is available from the start. Nothing is released in stages. "
...
def attach_field_behaviour():
    ...
    SRC = "out/Capability_Position_Read_FREE_FLAGSHIP_Workbook_v1.2_CANDIDATE.pdf"
