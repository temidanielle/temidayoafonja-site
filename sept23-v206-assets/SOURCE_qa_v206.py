# -*- coding: utf-8 -*-
"""September 23 flagship QA — v2.0.6 / v2.0.9 / v1.2.
...
DECK = f"{OUT}/PRESENTER_VERSION_Stay_or_Leave_Live_Career_Growth_Assessment_60MIN_v2.0.6_CANDIDATE.pptx"
DECK_PDF = DECK[:-5] + ".pdf"
PRIOR = f"{A}/PRESENTER_VERSION_Stay_or_Leave_Live_Career_Growth_Assessment_60MIN_v2.0.5_CANDIDATE.pptx"
SOP = f"{OUT}/Capability_Formation_Free_Flagship_SOP_Sept23_2026_60MIN_v2.0.9_CANDIDATE.docx"
SOP_PDF = SOP[:-5] + ".pdf"
CHK = f"{OUT}/Manual_Maven_and_Website_Edit_Checklist_v1.2.docx"
...
chk("J", "SOP is v2.0.9 and names deck v2.0.6",
    "v2.0.9" in SOPT and "60MIN_v2.0.6_CANDIDATE.pptx" in SOPT
    and "v2.0.8" not in SOPT and "v2.0.5" not in SOPT)
...
chk("J", "SOP exports at eight pages, with no stub final page",
    ...
    "REPINNED FROM SEVEN. The commercial architecture grew from two live offers to "
    "five and three sections gained operational rules, so the document genuinely "
    "needs the page. The stub-page test that the seven-page pin protected is kept")
...
chk("J", "Checklist is v1.2 and marks the already-current Maven copy",
    "v1.2" in CHKT and "ALREADY CURRENT" in CHKT
