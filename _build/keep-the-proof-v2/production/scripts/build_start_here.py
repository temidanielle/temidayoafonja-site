...
body{{font-family:'DM Sans',sans-serif;color:{INK};font-size:10.6pt;line-height:1.55;}}
.hero{{background:{NAVY};color:{CREAM};padding:0.5in 0.85in 0.42in;}}
.mark{{font-family:'DM Sans';font-weight:500;letter-spacing:.34em;font-size:8pt;color:{GOLD};}}
.htitle{{font-family:'Cormorant',serif;font-weight:600;font-size:38pt;line-height:1;margin:.35em 0 .12em;color:{CREAM};}}
.hsub{{font-family:'Cormorant',serif;font-style:italic;font-size:15pt;color:#dcd4c3;}}
.wrap{{padding:0.3in 0.85in 0.4in;}}
.lead{{font-size:10.6pt;line-height:1.5;margin-bottom:.45em;}}
.rule-box{{background:{CREAM};border-left:3px solid {GOLD};border-radius:6px;padding:.6em .9em;margin:.55em 0 .8em;}}
...
.rule-box .rt{{font-size:10.2pt;line-height:1.5;}}
.sh{{font-family:'Cormorant',serif;font-weight:600;font-size:16pt;color:{NAVY};margin:.15em 0 .05em;}}
.sh::after{{content:"";display:block;width:2em;height:2.5px;background:{GOLD};margin:.22em 0 .5em;}}
.fcard{{border:1px solid #e4dccb;border-top:3px solid {GOLD};border-radius:8px;padding:.5em .9em .58em;margin-bottom:.45em;page-break-inside:avoid;}}
.fk{{font-family:'DM Sans';font-weight:600;font-size:8pt;letter-spacing:.09em;color:{GOLD};margin-bottom:.12em;}}
.ft{{font-family:'Cormorant',serif;font-weight:600;font-size:16pt;color:{NAVY};line-height:1.05;margin-bottom:.28em;}}
.fb{{font-size:9.6pt;line-height:1.5;color:{INK};}}
.begin{{margin-top:.5em;}}
...
<div class="wrap">
  <p class="lead">You did excellent work. This system helps you hold on to the truth of it &mdash; the judgment, the decisions, and what changed &mdash; in language a stranger can follow and in a way that respects the people you work for. It builds an honest, portable record of what you actually did.</p>
