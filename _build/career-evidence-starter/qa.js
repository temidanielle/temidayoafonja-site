...
const DIR = __dirname;
const PDF = path.join(DIR, 'Keep_the_Proof_Career_Evidence_Starter_v1.2.pdf');
...
<script>
  ...
  pdfjsLib.getDocument('/_build/career-evidence-starter/Keep_the_Proof_Career_Evidence_Starter_v1.2.pdf')
